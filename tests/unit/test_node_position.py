...
# Create static method for the mock to avoid self parameter issues
@staticmethod
def mock_handle_position(message):
    ...
    try:
        ...
        TestNodePosition.current_instance.ideas_setter_mock(ideas)
        
        # For tests, use the mock save function
        TestNodePosition.current_instance.save_data_mock(get_store())
...
class TestNodePosition(unittest.TestCase):
    ...
    # Static variable to access current instance
    current_instance = None
    
    def setUp(self):
        """Set up test environment before each test"""
        # Store reference to current instance for mock function
        TestNodePosition.current_instance = self
        ...
        # Create a direct patch for message_queue._handle_position
        # Use new_callable to provide a custom callable
        self.handle_position_patch = patch('src.message_queue.message_queue._handle_position', 
                                           new=mock_handle_position)
