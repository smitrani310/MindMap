...
def mock_handle_position(message):
    ...
    try:
        ...
        # Use the mock for updating
        TestDragEndIntegration.current_instance.save_data_mock(get_store())
...
class TestDragEndIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        TestDragEndIntegration.current_instance = self
    ...
    def test_direct_update_in_main(self):
        ...
        # Directly call the mock - don't use the original save_data
        self.save_data_mock(get_store())
